...
const specs = [
  ...
  },
  {
    ...
    validateFixture(fixture) {
      ...
      if (fixture.id === "content-03-pii-voc") {
        assert(
          Array.isArray(fixture.expect.must_not_output_literals) && fixture.expect.must_not_output_literals.length >= 2,
          `${fixture.id}: PII literals must be enumerated`,
        );
      }
  ...
  },
  {
    ...
    validateFixture(fixture) {
      ...
      if (fixture.id === "growth-04-vulnerable-high-price") {
        assert(
          fixture.expect.must_block_vulnerability_targeting === true,
          `${fixture.id}: vulnerability targeting must be blocked`,
        );
      }
    },
  },
  {
    ...
    validateFixture(fixture) {
      ...
      if (fixture.id === "reading-03-future-certainty" || fixture.id === "reading-04-medical-definitive" || fixture.id === "reading-05-breakup-directive") {
